								...
								<div class="contact-form" id="pro-info">
									<div class="field-wrap two-fields-wrap">
										<div class="field-div">
											...
											<input type="text" placeholder="Microchip Id Number" name="microchip_id" class="text-data" id="sname_input" value="<?= (isset($_GET['id'])) ? $_GET['id'] : "" ?>" />	<span class="error" id="error"></span>
										</div>
										<div class="field-div">
											<label></label>
											<input type="text" name="conf_microchip_id" placeholder="Confirm Microchip Id Number" class="text-data" value="<?= (isset($_GET['id'])) ? $_GET['id'] : "" ?>" />
										</div>
									</div>
									<div class="field-wrap two-fields-wrap">
										<div class="field-div">
									...
									<div class="field-div">
										...
										<input type="text" name="pet_date_of_birth" id="pet-dob1" placeholder="mm/dd/yyyy" autocomplete="off" class="input-10 input text-data date-mnth-yer">
									</div>
								</div>
								<div class="field-wrap two-fields-wrap">
									<div class="field-div">
									...
									<div class="contact-form" id="cus-info">
										...
										<div class="field-wrap two-fields-wrap">
											<div class="field-div">
												...
												<input type="text" name="p_prm_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="p-phone"  required="" readonly value="<?php echo $primary_home_number;?>"/>
											...
											<div class="field-div">
												...
												<input type="text" name="p_sec_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="ps-phone" value="<?php echo $primary_cell_number;?>" />
												<input type="hidden" name="p_sec_no_code" placeholder="1(555) 123-1234" class="user-data" value="<?php echo $primary_cell_number_code; ?>"/>
											</div>
										</div>
									</div>
										...
										<div class="step-acc-content">
											<div class="contact-form" id="sec-cont-info">
												...
												<div class="field-wrap two-fields-wrap">
													<div class="field-div">
														<label>Primary Phone Number</label>
														<input type="number" name="s_prm_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="sp-phone" value="<?php echo $Sprimary_home_number;?>" />
													...
													<div class="field-div">
														<label>Secondary Phone Number</label>
														<input type="number" name="s_sec_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="ss-phone" value="<?php echo $Sprimary_cell_number;?>" />
								...
								<?php }else{ ?>
									<div class="contact-form" id="cus-info">
										...
										<div class="field-wrap two-fields-wrap">
											...
											<div class="field-div">
												<label>Secondary Phone Number </label>
												<input type="number" name="p_sec_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="ps-phone" value="" />
												<input type="hidden" name="p_sec_no_code" placeholder="1(555) 123-1234" class="user-data" />
											</div>
										</div>
									</div>
									<div class="step-accordion">
											...
											<div class="contact-form" id="sec-cont-info">
												...
												<div class="field-wrap two-fields-wrap">
													...
													<div class="field-div">
														<label>Secondary Phone Number</label>
														<input type="number" name="s_sec_no" placeholder="1(555) 123-1234" class="user-data phone-number" id="ss-phone" value="<?php echo $Sprimary_cell_number;?>" />
														<input type="hidden" name="s_sec_no_code" placeholder="1(555) 123-1234" class="user-data \" />
													</div>
												</div>
											</div>
										</div>

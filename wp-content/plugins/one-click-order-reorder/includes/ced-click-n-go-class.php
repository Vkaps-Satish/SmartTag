	...
	class Ced_Click_n_Go {
		...
		function ced_cng_prefix_ajax_get_order_cart() {
			...
			foreach ( $order->get_items() as $product_info ) {
				...
				// var_dump($product_info);die("ocean");
				$product_id = ( int ) apply_filters ( 'woocommerce_add_to_cart_product_id', $product_info ['product_id'] );
				...
				foreach ( $product_info ['item_meta'] as $product_meta_name => $product_meta_value ) {
					if ( taxonomy_is_product_attribute( $product_meta_name ) ) {
						// echo "test";
						// print_r($product_meta_value);
						// die;
						$all_variations [$product_meta_name] = $product_meta_value;
					} else {
						// echo "test111";die;
						...
						// print_r($all_variations);die;
				 // $meta_value = $product_info->get_meta("BackLine1");
				 // die($meta_value);
				
				$cart_product_data['engraving_front_line_1'] = $product_info->get_meta("FrontLine1");
				$cart_product_data['engraving_front_line_2'] = $product_info->get_meta("FrontLine2");
				$cart_product_data['engraving_front_line_3'] = $product_info->get_meta("FrontLine3");
				$cart_product_data['engraving_front_line_4'] = $product_info->get_meta("FrontLine4");
				
				$cart_product_data['engraving_back_line_1'] = $product_info->get_meta("BackLine1");
				$cart_product_data['engraving_back_line_2'] = $product_info->get_meta("BackLine2");
				$cart_product_data['engraving_back_line_3'] = $product_info->get_meta("BackLine3");
				$cart_product_data['engraving_back_line_4'] = $product_info->get_meta("BackLine4");

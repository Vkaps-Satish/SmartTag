...
class eemail
{
    ...
    static function send($to, $subject, $message, $headers, $attachments)
    {
        ...
        $emailsend = $Email->Send($subject, $from_email, $from_name, null, null, null, null, $reply_to, $reply_to_name, $to, array(), $cc, $bcc, array(), array(), null, 'Elastic Email Sender', $message_bodyHTML, $message_bodyText, $charset, null, null, ApiTypes\EncodingType::None, null, $attachments, $headers, null, array(), null, null, get_option('ee_send-email-type'));

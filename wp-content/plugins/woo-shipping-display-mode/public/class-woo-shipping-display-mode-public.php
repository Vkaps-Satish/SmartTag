...
class Woo_Shipping_Display_Mode_Public {
	...
	public function wo_shipping_woocommerce_shipping_chosen_method_custom( $get_default_method_available_methods_chosen_method, $available_methods ) {
	 ...
	 * BN code added
	 */
	function wo_shipping_paypal_bn_code_filter_woo_shipping_display_mode( $paypal_args ) {

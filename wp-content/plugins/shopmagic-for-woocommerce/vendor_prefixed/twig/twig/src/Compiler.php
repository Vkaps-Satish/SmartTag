 ...
 */
class Compiler implements \ShopMagicVendor\Twig_CompilerInterface
{
    protected $lastLine;
    protected $source;
     ...
     * @return $this
     */
    public function compile(\ShopMagicVendor\Twig_NodeInterface $node, $indentation = 0)
    {
        $this->lastLine = null;
        $this->source = '';
        $this->debugInfo = [];
    ...
    public function subcompile(\ShopMagicVendor\Twig_NodeInterface $node, $raw = \true)
    {
        if (\false === $raw) {
     ...
     * @return $this
     */
    public function addDebugInfo(\ShopMagicVendor\Twig_NodeInterface $node)
    {
...
\class_alias('ShopMagicVendor\\Twig\\Compiler', 'ShopMagicVendor\\Twig_Compiler');

 ...
 */
namespace ShopMagicVendor\Twig\Error;
...
class Error extends \Exception
{
    ...
    public function __construct($message, $lineno = -1, $source = null, \Exception $previous = null)
    {
        if (null === $source) {
            $name = null;
        } elseif (!$source instanceof \ShopMagicVendor\Twig\Source) {
    ...
    {
        return $this->filename ? new \ShopMagicVendor\Twig\Source($this->sourceCode, $this->filename, $this->sourcePath) : null;
    }
    /**
     * Sets the source context of the Twig template where the error occurred.
     */
    public function setSourceContext(\ShopMagicVendor\Twig\Source $source = null)
    {
        if (null === $source) {
    ...
    protected function guessTemplateInfo()
    {
        ...
        foreach ($backtrace as $trace) {
            if (isset($trace['object']) && $trace['object'] instanceof \ShopMagicVendor\Twig\Template && 'Twig_Template' !== \get_class($trace['object'])) {
...
\class_alias('ShopMagicVendor\\Twig\\Error\\Error', 'ShopMagicVendor\\Twig_Error');

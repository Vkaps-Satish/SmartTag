 ...
 * @internal
 */
class StagingExtension extends \ShopMagicVendor\Twig\Extension\AbstractExtension
{
    protected $functions = [];
    protected $filters = [];
    protected $visitors = [];
...
\class_alias('ShopMagicVendor\\Twig\\Extension\\StagingExtension', 'ShopMagicVendor\\Twig_Extension_Staging');

...
use ShopMagicVendor\Twig\Cache\CacheInterface;
use ShopMagicVendor\Twig\Cache\FilesystemCache;
use ShopMagicVendor\Twig\Cache\NullCache;
...
use ShopMagicVendor\Twig\Extension\CoreExtension;
use ShopMagicVendor\Twig\Extension\EscaperExtension;
use ShopMagicVendor\Twig\Extension\ExtensionInterface;
use ShopMagicVendor\Twig\Extension\GlobalsInterface;
use ShopMagicVendor\Twig\Extension\InitRuntimeInterface;
use ShopMagicVendor\Twig\Extension\OptimizerExtension;
use ShopMagicVendor\Twig\Extension\StagingExtension;
use ShopMagicVendor\Twig\Loader\ArrayLoader;
use ShopMagicVendor\Twig\Loader\ChainLoader;
use ShopMagicVendor\Twig\Loader\LoaderInterface;
use ShopMagicVendor\Twig\Loader\SourceContextLoaderInterface;
use ShopMagicVendor\Twig\Node\ModuleNode;
use ShopMagicVendor\Twig\NodeVisitor\NodeVisitorInterface;
use ShopMagicVendor\Twig\RuntimeLoader\RuntimeLoaderInterface;
use ShopMagicVendor\Twig\TokenParser\TokenParserInterface;
/**
...
class Environment
{
     ...
     */
    public function __construct(\ShopMagicVendor\Twig\Loader\LoaderInterface $loader = null, $options = [])
    {
        if (null !== $loader) {
        ...
        $options = \array_merge(['debug' => \false, 'charset' => 'UTF-8', 'base_template_class' => '\\Twig\\Template', 'strict_variables' => \false, 'autoescape' => 'html', 'cache' => \false, 'auto_reload' => null, 'optimizations' => -1], $options);
        ...
        $this->addExtension(new \ShopMagicVendor\Twig\Extension\CoreExtension());
        $this->addExtension(new \ShopMagicVendor\Twig\Extension\EscaperExtension($options['autoescape']));
        $this->addExtension(new \ShopMagicVendor\Twig\Extension\OptimizerExtension($options['optimizations']));
        $this->staging = new \ShopMagicVendor\Twig\Extension\StagingExtension();
        // For BC
    ...
    public function setCache($cache)
    {
        if (\is_string($cache)) {
            ...
            $this->cache = new \ShopMagicVendor\Twig\Cache\FilesystemCache($cache);
        } elseif (\false === $cache) {
            $this->originalCache = $cache;
            $this->cache = new \ShopMagicVendor\Twig\Cache\NullCache();
        } elseif (null === $cache) {
            ...
            $this->cache = new \ShopMagicVendor\Twig\Cache\NullCache();
        } elseif ($cache instanceof \ShopMagicVendor\Twig\Cache\CacheInterface) {
    ...
    {
        if ($name instanceof \ShopMagicVendor\Twig\TemplateWrapper) {
            return $name;
        }
        if ($name instanceof \ShopMagicVendor\Twig\Template) {
            return new \ShopMagicVendor\Twig\TemplateWrapper($this, $name);
        }
        return new \ShopMagicVendor\Twig\TemplateWrapper($this, $this->loadTemplate($name));
    }
    /**
        ...
        if (!\class_exists($cls, \false)) {
            ...
            if (!\class_exists($cls, \false)) {
                ...
                if (!$loader instanceof \ShopMagicVendor\Twig\Loader\SourceContextLoaderInterface) {
                    $source = new \ShopMagicVendor\Twig\Source($loader->getSource($name), $name);
                } else {
            ...
            if (!\class_exists($cls, \false)) {
                throw new \ShopMagicVendor\Twig\Error\RuntimeError(\sprintf('Failed to load Twig template "%s", index "%s": cache might be corrupted.', $name, $index), -1, $source);
            }
        }
    ...
    public function createTemplate($template, $name = null)
    {
        ...
        $loader = new \ShopMagicVendor\Twig\Loader\ChainLoader([new \ShopMagicVendor\Twig\Loader\ArrayLoader([$name => $template]), $current = $this->getLoader()]);
        $this->setLoader($loader);
        try {
            $template = new \ShopMagicVendor\Twig\TemplateWrapper($this, $this->loadTemplate($name));
        } catch (\Exception $e) {
    ...
    public function resolveTemplate($names)
    {
        ...
        throw new \ShopMagicVendor\Twig\Error\LoaderError(\sprintf('Unable to find one of the following templates: "%s".', \implode('", "', $names)));
    }
    /**
    ...
    public function getLexer()
    {
        ...
        if (null === $this->lexer) {
            $this->lexer = new \ShopMagicVendor\Twig\Lexer($this);
        }
        return $this->lexer;
    }
    public function setLexer(\ShopMagicVendor\Twig_LexerInterface $lexer)
    {
        $this->lexer = $lexer;
    }
    /**
    ...
    {
        if (!$source instanceof \ShopMagicVendor\Twig\Source) {
            ...
            $source = new \ShopMagicVendor\Twig\Source($source, $name);
        }
        if (null === $this->lexer) {
            $this->lexer = new \ShopMagicVendor\Twig\Lexer($this);
        }
    ...
    public function getParser()
    {
        @\trigger_error(\sprintf('The %s() method is deprecated since version 1.25 and will be removed in 2.0.', __FUNCTION__), \E_USER_DEPRECATED);
        if (null === $this->parser) {
            $this->parser = new \ShopMagicVendor\Twig\Parser($this);
        }
        return $this->parser;
    }
    public function setParser(\ShopMagicVendor\Twig_ParserInterface $parser)
    {
        $this->parser = $parser;
    }
    /**
     ...
     */
    public function parse(\ShopMagicVendor\Twig\TokenStream $stream)
    {
        if (null === $this->parser) {
            $this->parser = new \ShopMagicVendor\Twig\Parser($this);
        }
    ...
    public function getCompiler()
    {
        ...
        if (null === $this->compiler) {
            $this->compiler = new \ShopMagicVendor\Twig\Compiler($this);
        }
        return $this->compiler;
    }
    public function setCompiler(\ShopMagicVendor\Twig_CompilerInterface $compiler)
    {
     ...
     */
    public function compile(\ShopMagicVendor\Twig_NodeInterface $node)
    {
        if (null === $this->compiler) {
            $this->compiler = new \ShopMagicVendor\Twig\Compiler($this);
        }
    ...
    public function compileSource($source, $name = null)
    {
        ...
        } catch (\ShopMagicVendor\Twig\Error\Error $e) {
            $e->setSourceContext($source);
            throw $e;
        } catch (\Exception $e) {
            throw new \ShopMagicVendor\Twig\Error\SyntaxError(\sprintf('An exception has been thrown during the compilation of a template ("%s").', $e->getMessage()), -1, $source, $e);
        }
    }
    public function setLoader(\ShopMagicVendor\Twig\Loader\LoaderInterface $loader)
    {
        if (!$loader instanceof \ShopMagicVendor\Twig\Loader\SourceContextLoaderInterface && 0 !== \strpos(\get_class($loader), 'Mock_')) {
    ...
    public function initRuntime()
    {
        ...
        foreach ($this->getExtensions() as $name => $extension) {
            if (!$extension instanceof \ShopMagicVendor\Twig\Extension\InitRuntimeInterface) {
     ...
     */
    public function addRuntimeLoader(\ShopMagicVendor\Twig\RuntimeLoader\RuntimeLoaderInterface $loader)
    {
    ...
    public function getExtension($class)
    {
        ...
        if (!isset($this->extensionsByClass[$class])) {
            throw new \ShopMagicVendor\Twig\Error\RuntimeError(\sprintf('The "%s" extension is not enabled.', $class));
        }
    ...
    public function getRuntime($class)
    {
        ...
        throw new \ShopMagicVendor\Twig\Error\RuntimeError(\sprintf('Unable to load the "%s" runtime.', $class));
    }
    public function addExtension(\ShopMagicVendor\Twig\Extension\ExtensionInterface $extension)
    {
    ...
    public function addTokenParser(\ShopMagicVendor\Twig\TokenParser\TokenParserInterface $parser)
    {
        if ($this->extensionInitialized) {
    ...
    public function getTags()
    {
        ...
        foreach ($this->getTokenParsers()->getParsers() as $parser) {
            if ($parser instanceof \ShopMagicVendor\Twig\TokenParser\TokenParserInterface) {
                $tags[$parser->getTag()] = $parser;
            }
        }
        return $tags;
    }
    public function addNodeVisitor(\ShopMagicVendor\Twig\NodeVisitor\NodeVisitorInterface $visitor)
    {
        if ($this->extensionInitialized) {
    ...
    {
        if (!$name instanceof \ShopMagicVendor\Twig\TwigFilter && !($filter instanceof \ShopMagicVendor\Twig\TwigFilter || $filter instanceof \ShopMagicVendor\Twig_FilterInterface)) {
            throw new \LogicException('A filter must be an instance of \\Twig_FilterInterface or \\Twig_SimpleFilter.');
        }
        if ($name instanceof \ShopMagicVendor\Twig\TwigFilter) {
            $filter = $name;
            $name = $filter->getName();
        } else {
    ...
    {
        if (!$name instanceof \ShopMagicVendor\Twig\TwigTest && !($test instanceof \ShopMagicVendor\Twig\TwigTest || $test instanceof \ShopMagicVendor\Twig_TestInterface)) {
            throw new \LogicException('A test must be an instance of \\Twig_TestInterface or \\Twig_SimpleTest.');
        }
        if ($name instanceof \ShopMagicVendor\Twig\TwigTest) {
            $test = $name;
            $name = $test->getName();
        } else {
    ...
    {
        if (!$name instanceof \ShopMagicVendor\Twig\TwigFunction && !($function instanceof \ShopMagicVendor\Twig\TwigFunction || $function instanceof \ShopMagicVendor\Twig_FunctionInterface)) {
            throw new \LogicException('A function must be an instance of \\Twig_FunctionInterface or \\Twig_SimpleFunction.');
        }
        if ($name instanceof \ShopMagicVendor\Twig\TwigFunction) {
            $function = $name;
    ...
    public function computeAlternatives($name, $items)
    {
        ...
        return \ShopMagicVendor\Twig\Error\SyntaxError::computeAlternatives($name, $items);
    }
    /**
     * @internal
     */
    protected function initGlobals()
    {
        ...
        foreach ($this->extensions as $name => $extension) {
            if (!$extension instanceof \ShopMagicVendor\Twig\Extension\GlobalsInterface) {
    ...
    protected function initExtensions()
    {
        ...
        $this->parsers = new \ShopMagicVendor\Twig_TokenParserBroker([], [], \false);
        $this->filters = [];
        $this->functions = [];
        $this->tests = [];
        $this->visitors = [];
     ...
     * @internal
     */
    protected function initExtension(\ShopMagicVendor\Twig\Extension\ExtensionInterface $extension)
    {
        // filters
        ...
        foreach ($extension->getTokenParsers() as $parser) {
            ...
            } elseif ($parser instanceof \ShopMagicVendor\Twig_TokenParserBrokerInterface) {
    ...
    {
        $hashParts = \array_merge(\array_keys($this->extensions), [(int) \function_exists('ShopMagicVendor\\twig_template_get_attributes'), \PHP_MAJOR_VERSION, \PHP_MINOR_VERSION, self::VERSION, (int) $this->debug, $this->baseTemplateClass, (int) $this->strictVariables]);
        $this->optionsHash = \implode(':', $hashParts);
    }
}
\class_alias('ShopMagicVendor\\Twig\\Environment', 'ShopMagicVendor\\Twig_Environment');

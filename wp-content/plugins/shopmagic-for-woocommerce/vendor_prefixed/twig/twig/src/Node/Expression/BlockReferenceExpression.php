 ...
 */
class BlockReferenceExpression extends \ShopMagicVendor\Twig\Node\Expression\AbstractExpression
{
    /**
     * @param Node|null $template
     */
    public function __construct(\ShopMagicVendor\Twig_NodeInterface $name, $template = null, $lineno, $tag = null)
    {
        if (\is_bool($template)) {
    ...
    private function compileTemplateCall(\ShopMagicVendor\Twig\Compiler $compiler, $method)
    {
    ...
    private function compileBlockArguments(\ShopMagicVendor\Twig\Compiler $compiler)
    {
...
\class_alias('ShopMagicVendor\\Twig\\Node\\Expression\\BlockReferenceExpression', 'ShopMagicVendor\\Twig_Node_Expression_BlockReference');

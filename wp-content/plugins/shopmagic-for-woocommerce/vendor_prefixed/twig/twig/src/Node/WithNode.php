 ...
 */
class WithNode extends \ShopMagicVendor\Twig\Node\Node
{
    public function __construct(\ShopMagicVendor\Twig\Node\Node $body, \ShopMagicVendor\Twig\Node\Node $variables = null, $only = \false, $lineno, $tag = null)
    {
        $nodes = ['body' => $body];
        if (null !== $variables) {
...
\class_alias('ShopMagicVendor\\Twig\\Node\\WithNode', 'ShopMagicVendor\\Twig_Node_With');

 ...
 */
class SetNode extends \ShopMagicVendor\Twig\Node\Node implements \ShopMagicVendor\Twig\Node\NodeCaptureInterface
{
    public function __construct($capture, \ShopMagicVendor\Twig_NodeInterface $names, \ShopMagicVendor\Twig_NodeInterface $values, $lineno, $tag = null)
    {
        ...
        if ($this->getAttribute('capture')) {
            ...
            if ($values instanceof \ShopMagicVendor\Twig\Node\TextNode) {
                $this->setNode('values', new \ShopMagicVendor\Twig\Node\Expression\ConstantExpression($values->getAttribute('data'), $values->getTemplateLine()));
...
\class_alias('ShopMagicVendor\\Twig\\Node\\SetNode', 'ShopMagicVendor\\Twig_Node_Set');

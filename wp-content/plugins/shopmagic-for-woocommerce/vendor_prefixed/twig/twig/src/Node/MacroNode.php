 ...
 */
class MacroNode extends \ShopMagicVendor\Twig\Node\Node
{
    const VARARGS_NAME = 'varargs';
    public function __construct($name, \ShopMagicVendor\Twig_NodeInterface $body, \ShopMagicVendor\Twig_NodeInterface $arguments, $lineno, $tag = null)
    {
        foreach ($arguments as $argumentName => $argument) {
            if (self::VARARGS_NAME === $argumentName) {
                throw new \ShopMagicVendor\Twig\Error\SyntaxError(\sprintf('The argument "%s" in macro "%s" cannot be defined because the variable "%s" is reserved for arbitrary arguments.', self::VARARGS_NAME, $name, self::VARARGS_NAME), $argument->getTemplateLine(), $argument->getSourceContext());
            }
        }
...
\class_alias('ShopMagicVendor\\Twig\\Node\\MacroNode', 'ShopMagicVendor\\Twig_Node_Macro');

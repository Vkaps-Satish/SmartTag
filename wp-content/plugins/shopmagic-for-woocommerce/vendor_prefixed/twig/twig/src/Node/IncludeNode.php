 ...
 */
class IncludeNode extends \ShopMagicVendor\Twig\Node\Node implements \ShopMagicVendor\Twig\Node\NodeOutputInterface
{
    public function __construct(\ShopMagicVendor\Twig\Node\Expression\AbstractExpression $expr, \ShopMagicVendor\Twig\Node\Expression\AbstractExpression $variables = null, $only = \false, $ignoreMissing = \false, $lineno, $tag = null)
    {
        $nodes = ['expr' => $expr];
        if (null !== $variables) {
    ...
    protected function addGetTemplate(\ShopMagicVendor\Twig\Compiler $compiler)
    {
    ...
    protected function addTemplateArguments(\ShopMagicVendor\Twig\Compiler $compiler)
    {
...
\class_alias('ShopMagicVendor\\Twig\\Node\\IncludeNode', 'ShopMagicVendor\\Twig_Node_Include');

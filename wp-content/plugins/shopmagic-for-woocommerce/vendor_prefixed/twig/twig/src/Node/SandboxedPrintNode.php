 ...
 */
class SandboxedPrintNode extends \ShopMagicVendor\Twig\Node\PrintNode
{
    public function compile(\ShopMagicVendor\Twig\Compiler $compiler)
    {
        ...
        if ($expr instanceof \ShopMagicVendor\Twig\Node\Expression\ConstantExpression) {
            ...
            $compiler->write('$this->env->getExtension(\'\\Twig\\Extension\\SandboxExtension\')->ensureToStringAllowed(')->subcompile($expr)->raw(");\n");
        }
    }
    /**
     ...
     * @return Node
     */
    protected function removeNodeFilter(\ShopMagicVendor\Twig\Node\Node $node)
    {
...
\class_alias('ShopMagicVendor\\Twig\\Node\\SandboxedPrintNode', 'ShopMagicVendor\\Twig_Node_SandboxedPrint');

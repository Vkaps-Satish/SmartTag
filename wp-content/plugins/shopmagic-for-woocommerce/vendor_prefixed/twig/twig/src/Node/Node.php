 ...
 */
class Node implements \ShopMagicVendor\Twig_NodeInterface
{
    protected $nodes;
    ...
    public function __construct(array $nodes = [], array $attributes = [], $lineno = 0, $tag = null)
    {
        foreach ($nodes as $name => $node) {
            if (!$node instanceof \ShopMagicVendor\Twig_NodeInterface) {
    ...
    public function setSourceContext(\ShopMagicVendor\Twig\Source $source)
    {
...
\class_alias('ShopMagicVendor\\Twig\\Node\\Node', 'ShopMagicVendor\\Twig_Node');
// Ensure that the aliased name is loaded to keep BC for classes implementing the typehint with the old aliased name.
\class_exists('ShopMagicVendor\\Twig\\Compiler');

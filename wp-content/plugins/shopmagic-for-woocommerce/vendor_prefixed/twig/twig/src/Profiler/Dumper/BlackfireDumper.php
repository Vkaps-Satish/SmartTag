...
EOF;
    ...
    private function dumpChildren($parent, \ShopMagicVendor\Twig\Profiler\Profile $profile, &$data)
    {
    ...
    private function dumpProfile($edge, \ShopMagicVendor\Twig\Profiler\Profile $profile, &$data)
    {
        if (isset($data[$edge])) {
            ++$data[$edge]['ct'];
...
\class_alias('ShopMagicVendor\\Twig\\Profiler\\Dumper\\BlackfireDumper', 'ShopMagicVendor\\Twig_Profiler_Dumper_Blackfire');

...
use ShopMagicVendor\Composer\Downloader\FilesystemException;
 ...
 */
class CreateCodeceptionTests extends \ShopMagicVendor\WPDesk\Composer\Codeception\Commands\BaseCommand
{
    use SedTrait;
    /**
     * Configure command.
    ...
    {
        if (!\copy($source, $dest)) {
            throw new \ShopMagicVendor\Composer\Downloader\FilesystemException($exceptionMessage);
        }
    }
    /**

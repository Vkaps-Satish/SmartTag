...
class ShopMagic_Twig_Template_DBLoader implements \ShopMagicVendor\Twig_LoaderInterface, \ShopMagicVendor\Twig_ExistsLoaderInterface {
	...
	public function getSource( $name ) {
		...
		if ( is_array( $actions ) ) { // if meta exists and it is an array
			...
			throw new \ShopMagicVendor\Twig_Error_Loader( sprintf( 'Template "%s" does not exist.', $name ) );
		}

...
if ( ! function_exists( 'shopmagic_welcome_page' ) ) {
	...
	function shopmagic_welcome_page() {
		...
		$shopmagic_sub_menu = add_submenu_page(
			...
			__( 'Start Here', 'shopmagic-for-woocommerce' ), // The text to be displayed in the title tags of the page when the menu is selected.
	    	__( 'Start Here', 'shopmagic-for-woocommerce' ), // The text to be used for the menu.

...
class ShopMagic_Logger_Table extends WP_List_Table {
	...
	function __construct() {
		parent::__construct( array(
			'singular' => __( 'Event', 'shopmagic-for-woocommerce' ), //singular name of the listed records
			'plural'   => __( 'Events', 'shopmagic-for-woocommerce' ), //plural name of the listed records
	...
	public function no_items() {
		_e( 'No events avaliable.', 'shopmagic-for-woocommerce' );
	}
	...
	function get_columns() {
		$columns = array(
			'id'       => __( '#', 'shopmagic-for-woocommerce' ),
			'time'     => __( 'Time', 'shopmagic-for-woocommerce' ),
			'severity' => __( 'Severity', 'shopmagic-for-woocommerce' ),
			'source'   => __( 'Source', 'shopmagic-for-woocommerce' ),
			'title'    => __( 'Message', 'shopmagic-for-woocommerce' )
		);
...
//        error_log( $item[$column_name]);
	...
	function extra_tablenav( $which ) {
		...
		if ( $which == "top" ) {
			...
			$severityString = '<option value="">' . __( 'Severity', 'shopmagic-for-woocommerce' ) . '</option>';
			...
			$sourceString = '<option value="">' . __( 'Source', 'shopmagic-for-woocommerce' ) . '</option>';

...
class ShopMagic_Logger_Viewer {
	...
	function add_settings_section( $sections ) {
		...
		$sections[ $this->logger_section ] = __( 'Debug', 'shopmagic-for-woocommerce' );
	...
	function show_log() {
		...
		if ( $this->logger_section == $current_section ) {
            ...
            <div class="error-icon"><span class="dashicons dashicons-warning"></span>
                <div class="error-icon-tooltip"><?php _e( 'Network connection error', 'shopmagic-for-woocommerce' ); ?></div>
            </div>
            <div class="spinner"></div>
            <div id="record-log-detail-content">
                <div class="record-field record-id"><?php _e( 'ID', 'shopmagic-for-woocommerce' ); ?>:&nbsp;<span
                            class="value"></span></div>
                <div class="record-field record-time"><?php _e( 'Time', 'shopmagic-for-woocommerce' ); ?>:&nbsp;<span
                            class="value"></span></div>
                <div class="record-field record-severity"><?php _e( 'Severity', 'shopmagic-for-woocommerce' ); ?>:&nbsp;<span
                            class="value"></span></div>
                <div class="record-field record-source"><?php _e( 'Source', 'shopmagic-for-woocommerce' ); ?>
                    :&nbsp;<span class="value"></span></div>
                <div class="record-field record-description"><?php _e( 'Description', 'shopmagic-for-woocommerce' ); ?>:&nbsp;<div
                            class="value"></div>
                </div>
            </div>
            </div><?php

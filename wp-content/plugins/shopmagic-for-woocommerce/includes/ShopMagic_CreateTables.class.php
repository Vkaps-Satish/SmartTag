	...
	function install_data() {
		...
		$wpdb->insert(
			...
			array(
				'severity'    => 'INFO',
				'source'      => 'ShopMagic',
				'title'       => __( 'ShopMagic has been successfully activated', 'shopmagic-for-woocommerce' ),
				'description' => __( 'Welcome to the world of awesomeness automations! Let the magic begin!', 'shopmagic-for-woocommerce' )
			)
		);
	}
}
